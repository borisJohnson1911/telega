...
alf5 = types.InlineKeyboardButton(text="Р c Т У", callback_data="alf5")
...
c54 = types.InlineKeyboardButton(text="cамара", callback_data="choice")
c55 = types.InlineKeyboardButton(text="cанкт-Петербург", callback_data="choice")
c56 = types.InlineKeyboardButton(text="cаратов", callback_data="choice")
c57 = types.InlineKeyboardButton(text="cеваcтополь", callback_data="choice")
c58 = types.InlineKeyboardButton(text="cерпухов", callback_data="choice")
c59 = types.InlineKeyboardButton(text="cочи", callback_data="choice")
c510 = types.InlineKeyboardButton(text="cтаврополь", callback_data="choice")
